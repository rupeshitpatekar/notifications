...
For example, to start a pgsql database in a docker container, run:

```
docker-compose -f src/main/docker/pgsql.yml up -d
```

To stop it and remove the container, run:

```
docker-compose -f src/main/docker/pgsql.yml down
```
